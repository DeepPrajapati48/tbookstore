  ...
  return (
    <div className="py-8">
         <div className="flex justify-center flex-col items-center p-4">
                <h1 className="text-4xl font-bold text-center p-3">LOGIN OR CREATE ACCOUNT</h1>
      ...
      <form method='POST' onSubmit={handleSubmit} className='flex justify-center items-center gap-5'>
        <div className='border-2 rounded-x1 p-5 flex flex-col gap-5 shadow-lg w-[400px]'>
          ...
          <div className='text-center font-semibold'>Register here! <Link to="/register" className="text-blue-500">Register</Link></div>
        </div>
      </form>
